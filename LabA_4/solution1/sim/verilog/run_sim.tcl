...
if {[file isfile axi_interfaces.autotvin.dat]} {
	file delete -force axi_interfaces.autotvin.dat
}

if {[file isfile axi_interfaces.autotvout.dat]} {
	file delete -force axi_interfaces.autotvout.dat
}
