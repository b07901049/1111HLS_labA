...
$(ObjDir)/axi_interfaces_test.c_pre.c.tb.o : axi_interfaces_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) axi_interfaces_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/axi_interfaces.c_pre.c.tb.o : axi_interfaces.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) axi_interfaces.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
