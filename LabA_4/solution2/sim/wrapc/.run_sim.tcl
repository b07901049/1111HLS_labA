...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axi_interfaces.autotvin.dat"
	set constFileTvOut       "axi_interfaces.autotvout.dat"
	set constFileHdlTvIn     "axi_interfaces.autohdltvin.dat"
	set constFileHdlTvOut    "axi_interfaces.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
