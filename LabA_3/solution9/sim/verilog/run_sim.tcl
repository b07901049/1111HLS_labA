...
if {[file isfile array_io.autotvin.dat]} {
	file delete -force array_io.autotvin.dat
}

if {[file isfile array_io.autotvout.dat]} {
	file delete -force array_io.autotvout.dat
}
