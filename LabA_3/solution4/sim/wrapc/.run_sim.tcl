...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "array_io.autotvin.dat"
	set constFileTvOut       "array_io.autotvout.dat"
	set constFileHdlTvIn     "array_io.autohdltvin.dat"
	set constFileHdlTvOut    "array_io.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
