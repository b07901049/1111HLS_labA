...
void apatb_array_io_sw(signed short *, signed short *);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @apatb_array_io_sw(i16* %%3, i16* %%4) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
  apatb_array_io_sw((signed short *)llvm_cbe_tmp__3, (signed short *)llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
