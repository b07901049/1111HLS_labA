...
{
transaction<16> tr(8);
aesl_fh.read(AUTOTB_TVOUT_PC_d_o_0, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_d_o_0, 8);
}
#else
{
...
{
transaction<16> tr(8);
aesl_fh.read(AUTOTB_TVOUT_PC_d_o_1, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_d_o_1, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
...
{
transaction<16> tr(8);
aesl_fh.read(AUTOTB_TVOUT_PC_d_o_2, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_d_o_2, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
...
{
transaction<16> tr(8);
aesl_fh.read(AUTOTB_TVOUT_PC_d_o_3, tr.p, tr.tbytes);
if (little_endian()) { tr.reorder(); }
tr.send<2>((char*)__xlx_apatb_param_d_o_3, 8);
}
#else
{
      static ifstream rtl_tv_out_file;
...
unsigned __xlx_offset_byte_param_d_o_0 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_o_0, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_0 = 0*2;
  if (__xlx_apatb_param_d_o_0) {
tr.import<2>((char*)__xlx_apatb_param_d_o_0, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_o_0, tr.p, tr.tbytes);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_0 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_o_0, s);
}
}
}
...
#endif
unsigned __xlx_offset_byte_param_d_o_1 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_o_1, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_1 = 0*2;
  if (__xlx_apatb_param_d_o_1) {
tr.import<2>((char*)__xlx_apatb_param_d_o_1, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_o_1, tr.p, tr.tbytes);
}
...
if (__xlx_apatb_param_d_o_1) {
for (size_t i = 0; i < 8; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_1 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_o_1, s);
}
}
}
...
#endif
unsigned __xlx_offset_byte_param_d_o_2 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_o_2, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_2 = 0*2;
  if (__xlx_apatb_param_d_o_2) {
tr.import<2>((char*)__xlx_apatb_param_d_o_2, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_o_2, tr.p, tr.tbytes);
}
...
if (__xlx_apatb_param_d_o_2) {
for (size_t i = 0; i < 8; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_2 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_o_2, s);
}
}
}
...
#endif
unsigned __xlx_offset_byte_param_d_o_3 = 0;
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVIN_d_o_3, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_3 = 0*2;
  if (__xlx_apatb_param_d_o_3) {
tr.import<2>((char*)__xlx_apatb_param_d_o_3, 8, 0);
  }
aesl_fh.write(AUTOTB_TVIN_d_o_3, tr.p, tr.tbytes);
}
...
if (__xlx_apatb_param_d_o_3) {
for (size_t i = 0; i < 8; ++i) {
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_3 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVIN_d_o_3, s);
}
}
}
...
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_d_o_0, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_0 = 0*2;
  if (__xlx_apatb_param_d_o_0) {
tr.import<2>((char*)__xlx_apatb_param_d_o_0, 8, 0);
  }
aesl_fh.write(AUTOTB_TVOUT_d_o_0, tr.p, tr.tbytes);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_0 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVOUT_d_o_0, s);
}
}
}
...
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_d_o_1, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_1 = 0*2;
  if (__xlx_apatb_param_d_o_1) {
tr.import<2>((char*)__xlx_apatb_param_d_o_1, 8, 0);
  }
aesl_fh.write(AUTOTB_TVOUT_d_o_1, tr.p, tr.tbytes);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_1 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVOUT_d_o_1, s);
}
}
}
...
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_d_o_2, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_2 = 0*2;
  if (__xlx_apatb_param_d_o_2) {
tr.import<2>((char*)__xlx_apatb_param_d_o_2, 8, 0);
  }
aesl_fh.write(AUTOTB_TVOUT_d_o_2, tr.p, tr.tbytes);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_2 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVOUT_d_o_2, s);
}
}
}
...
#ifdef USE_BINARY_TV_FILE
{
aesl_fh.touch(AUTOTB_TVOUT_d_o_3, 'b');
transaction<16> tr(8);
  __xlx_offset_byte_param_d_o_3 = 0*2;
  if (__xlx_apatb_param_d_o_3) {
tr.import<2>((char*)__xlx_apatb_param_d_o_3, 8, 0);
  }
aesl_fh.write(AUTOTB_TVOUT_d_o_3, tr.p, tr.tbytes);
}
...
unsigned char *pos = (unsigned char*)__xlx_apatb_param_d_o_3 + i * 2;
std::string s = formatData(pos, 16);
aesl_fh.write(AUTOTB_TVOUT_d_o_3, s);
}
}
}
