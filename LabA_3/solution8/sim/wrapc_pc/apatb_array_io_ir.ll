; ModuleID = 'D:/1111HLS/LabA/LabA_3/solution8/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @copy_in([32 x i16]* nonnull %0, [8 x i16]* nonnull align 512 %d_o_copy_0, [8 x i16]* nonnull align 512 %d_o_copy_1, [8 x i16]* nonnull align 512 %d_o_copy_2, [8 x i16]* nonnull align 512 %d_o_copy_3, [32 x i16]* nonnull %1, [16 x i16]* nonnull align 512 %d_i_copy_0, [16 x i16]* nonnull align 512 %d_i_copy_1)
  ...
  call void @copy_back([32 x i16]* %0, [8 x i16]* %d_o_copy_0, [8 x i16]* %d_o_copy_1, [8 x i16]* %d_o_copy_2, [8 x i16]* %d_o_copy_3, [32 x i16]* %1, [16 x i16]* %d_i_copy_0, [16 x i16]* %d_i_copy_1)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([32 x i16]* noalias readonly "orig.arg.no"="0", [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [32 x i16]* noalias readonly "orig.arg.no"="2", [16 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [16 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([32 x i16]* noalias "orig.arg.no"="0", [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [32 x i16]* noalias "orig.arg.no"="2", [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12) #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([32 x i16]* noalias "orig.arg.no"="0", [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_2, [8 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_3, [32 x i16]* noalias "orig.arg.no"="2", [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [16 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12) #5 {
entry:
  call void @onebyonecpy_hls.p0a32i16.11.12([32 x i16]* %0, [8 x i16]* align 512 %_0, [8 x i16]* align 512 %_1, [8 x i16]* align 512 %_2, [8 x i16]* align 512 %_3)
  ret void
}
...
!7 = !DIFile(filename: "D:/1111HLS/LabA/LabA_3/solution8/directives.tcl", directory: "D:\5C1111HLS\5CLabA")
...
!9 = !DIFile(filename: "LabA_3/array_io.c", directory: "D:\5C1111HLS\5CLabA")
!10 = !DISubroutineType(types: !11)
!11 = !{null, !12, !16}
!12 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !13, size: 64)
!13 = !DIDerivedType(tag: DW_TAG_typedef, name: "dout_t", file: !14, line: 52, baseType: !15)
!14 = !DIFile(filename: "LabA_3/array_io.h", directory: "D:\5C1111HLS\5CLabA")
...
!19 = !DIFile(filename: "D:/1111HLS/LabA/LabA_3/solution8/.autopilot/db\5Carray_io.pp.0.c", directory: "D:\5C1111HLS\5CLabA")
!20 = !{!21}
